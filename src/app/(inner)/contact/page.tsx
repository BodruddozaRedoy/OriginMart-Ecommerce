                    ...
                    <div className="container">
                        <div className="row">
                                ...
                                <div className="contact-left-area-main-wrapper">
                                    ...
                                    <div className="location-single-card">
                                        ...
                                        <div className="information">
                                            <h3 className="title">Ehasan Store</h3>
                                            <p>Jamtola Bazar, Mirpur, Dhaka, Bangladesh</p>
                                    ...
                                    <div className="location-single-card">
                                        ...
                                        <div className="information">
                                            <h3 className="title">Nijafa Store</h3>
                                            <p>Jamtola Bazar, Mirpur, Dhaka, Bangladesh</p>
                                            <a href="#" className="number">
                                                +880 (176) 259 6328
                                            </a>
                            ...
                            <div className="col-lg-8 pl--50 pl_sm--5 pl_md--5">
                                <iframe
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d116833.83187878219!2d90.33728799397399!3d23.78097572837469!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b8b087026b81%3A0x8fa563bbdd5904c2!2sDhaka!5e0!3m2!1sen!2sbd!4v1768124588595!5m2!1sen!2sbd"
                                    width={600}
                                    height={540}
                                    style={{ border: 0 }}
